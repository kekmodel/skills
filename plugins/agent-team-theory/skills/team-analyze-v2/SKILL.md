---
name: team-analyze-v2
description: "Analyze a task and recommend the best supported team architecture without creating a team or executing anything. V2: self-contained with full 3-axis tables, overlay logic, anti-pattern guards, decision tree, and team composition preview."
user_invocable: true
---
